export default function Lab1() {
    return (
        <div id="wd-lab1">
            ...
            <div id="wd-lists">
                ...
                <ol id="wd-your-favorite-recipe">
                    <li>Heat up the wok.</li>
                    <li>Add some MSG.</li>
                    <li>Stir fry, serve, and enjoy!</li>
                </ol>
                ...
                <li>Upheaval: Turning Points for Nations in Crisis</li>
                </ul>
            </div>
        ...
        <div id="wd-images">
            ...
            <br />
            <img id="wd-teslabot" src="images/teslabot.png" height="275px" />
        </div>
