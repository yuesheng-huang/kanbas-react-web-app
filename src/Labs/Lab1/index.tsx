export default function Lab1() {
    return (
        ...
        <div id="wd-images">
            ...
            <img id="wd-starship"
                width="400px"
            src="https://static.jdmexport.com/wp-content/uploads/sites/9/2022/12/08095258/toyota-ae86.jpg"
            />
            <br />
            Loading a local image:
            <br />
            <img id="wd-teslabot" src="images/ana_b747.png" height="275px" />
        </div>
